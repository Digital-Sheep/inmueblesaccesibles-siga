...
class ProcesoVentaInfolist
{
    ...
    private static function getEtapaEstado(ProcesoVenta $record, string $etapaKey): string
    {
        $estatusMap = [
            ...
            'APARTADO_VALIDADO' => 2,
            'ENGANCHE_SOLICITADO' => 3,
            'ENGANCHE_POR_VALIDAR' => 3,
            'ENGANCHE_PAGADO' => 3,
            'EN_DICTAMINACION' => 4,
            'DICTAMINADO_POSITIVO' => 4,
            'EN_PROCESO_COMPRA' => 5,
            'COMPRA_FINALIZADA' => 5,
    ...
    private static function getDescripcionEstado(ProcesoVenta $record): string
    {
        ...
        return match ($record->estatus) {
            ...
            'APARTADO_VALIDADO' => '✅ Apartado validado. Siguiente paso: Solicitar primer pago.',
            'EN_DICTAMINACION' => '⚖️ En proceso de dictaminación jurídica.',
            'DICTAMINADO_POSITIVO' => '✅ Dictamen aprobado. Siguiente paso: Iniciar proceso de compra (GAD).',
            'ENGANCHE_SOLICITADO' => '💰 Enganche solicitado. Esperando pago del cliente.',
            'ENGANCHE_POR_VALIDAR' => '⏳ Pago de enganche en validación.',
            'ENGANCHE_PAGADO' => '✅ Primer pago validado. Siguiente paso: Solicitar dictamen jurídico.',
